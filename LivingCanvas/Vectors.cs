...
namespace LivingCanvas {
	...
	public struct Vec3 {
		...
		public static implicit operator SKColor(Vec3 vec) =>
			new SKColor((byte) (vec.X * 255), (byte) (vec.Y * 255), (byte) (vec.Z * 255), 255);
	}
	...
	public struct Vec4 {
		...
		public static implicit operator SKColor(Vec4 vec) =>
			new SKColor((byte) (vec.X * 255), (byte) (vec.Y * 255), (byte) (vec.Z * 255), (byte) (vec.W * 255));
	}
}